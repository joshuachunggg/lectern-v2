...
begin
  ...
  select free_used, subscription_status, included_used, stripe_customer_id into is_free_used, subscription, used, customer from public.billing_accounts where owner_id = p_owner_id for update;
