...
declare is_free_used boolean; subscription text; used integer; customer text;
begin
  ...
  select accounts.free_used, accounts.subscription_status, accounts.included_used, accounts.stripe_customer_id into is_free_used, subscription, used, customer from public.billing_accounts accounts where accounts.owner_id = p_owner_id for update;
  if is_free_used is false then
